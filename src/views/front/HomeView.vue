<template>
  ...
  <section>
    <div class="container pt-32 pb-[480px]">
      ...
      <!-- Search Now Button -->
      <Button @click="openModal" variant="white-outline" size="base" class="btn-explore-icon-color w-full sm:w-[60%] xl:ml-[8%] xl:w-[50%] p-7 md:p-7 lg:p-7 hover:border-transparent">
