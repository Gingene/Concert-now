<template>
  ...
  <section 
    ...
    <swiper
      ...
      <article
        ...
        <router-link 
          :to="`/concerts/${concertActive.id}`" 
          class="w-full sm:w-[80%] xl:w-full 2xl:w-[80%] block">
          <Button 
            variant="white-outline" 
  ...
  <section 
    ...
    >
    <h2 
      class="font-black text-[60px] xs:text-[88px] sm:text-[110px] md:text-[120px] lg:text-[160px] text-stroke font-lato sm:mb-5 xl:-mb-20 xl:mr-[160px]"
      >
      ARTISTS
    </h2>
  ...
  <!-- Venue -->
  <section 
    class="container px-[8%] xs:px-[38px] md:px-[64px] lg:w-[800px] xl:w-[1000px] pb-[180px] sm:pb-[230px] md:pb-[200px] lg:pb-[250px] xl:pb-[280px] text-center"
    >
    <h2 
      class="font-black text-[60px] xs:text-[88px] sm:text-[110px] md:text-[120px] lg:text-[160px] text-stroke font-lato"
      >
      VENUES
    </h2>
    <swiper
    ...
    <section class="pt-[10rem] relative flex">
      ...
      <div class="mx-auto relative">
        ...
        <div class="xl:hidden bg-shadow-trans-text rounded-[40px] space-y-6 p-6 sm:p-12 w-auto lg:w-[636px] mt-6 sm:mt-[-2.6rem]">
          <h4 class="text-xl md:text-2xl lg:text-3xl font-bold">
            來複習演唱會歌單吧！
          </h4>
          <p>
          ...
          <Popover>
            <PopoverTrigger>
              <Button 
                ...
                探索歌單
                <svg 
                  class="hidden sm:block md:hidden pl-4" 
                  width="184" 
                  height="16" 
                  viewBox="0 0 184 16" 
                  fill="none" 
                ...
                <svg 
                  class="hidden md:block pl-4 ml-auto" 
                  width="341" 
                  height="16" 
                  viewBox="0 0 341 16" 
                  fill="none" 
          ...
          <Popover>
            <PopoverTrigger>
              <Button 
                ...
                <svg 
                  class="hidden xl:block 2xl:hidden pl-4" 
                  width="270" 
                  height="16" 
                  viewBox="0 0 341 16" 
                  fill="none" 
        ...
        <svg 
          class="hidden xl:block absolute right-0 bottom-[12.5rem]" 
          width="371" 
          height="132" 
          viewBox="0 0 371 132" 
