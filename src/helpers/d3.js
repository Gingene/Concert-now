...
(function (global, factory) {
  ...
  function selection_attr(name, value) {
    ...
    return this.each(
      (value == null ? (fullname.local ? attrRemoveNS : attrRemove) : typeof value === 'function' ? (fullname.local ? attrFunctionNS : attrFunction) : fullname.local ? attrConstantNS : attrConstant)(
        fullname,
        value,
      ),
    );
  ...
  function selection_style(name, value, priority) {
    return arguments.length > 1
      ? this.each((value == null ? styleRemove : typeof value === 'function' ? styleFunction : styleConstant)(name, value, priority == null ? '' : priority))
  ...
  function transition_style(name, value, priority) {
    ...
    return value == null
      ...
      : typeof value === 'function'
        ? this.styleTween(name, styleFunction$1(name, i, tweenValue(this, 'style.' + name, value))).each(styleMaybeRemove(this._id, name))
  ...
  function clipAntimeridianIntersect(lambda0, phi0, lambda1, phi1) {
    ...
    return abs(sinLambda0Lambda1) > epsilon$2
      ? atan((sin$1(phi0) * (cosPhi1 = cos$1(phi1)) * sin$1(lambda1) - sin$1(phi1) * (cosPhi0 = cos$1(phi0)) * sin$1(lambda0)) / (cosPhi0 * cosPhi1 * sinLambda0Lambda1))
      : (phi0 + phi1) / 2;
  }
  ...
  function projectionMutator(projectAt) {
    ...
    projection.rotate = function (_) {
      return arguments.length
        ? ((deltaLambda = (_[0] % 360) * radians), (deltaPhi = (_[1] % 360) * radians), (deltaGamma = _.length > 2 ? (_[2] % 360) * radians : 0), recenter())
  ...
  function transformer$3() {
    ...
    scale.domain = function (_) {
      return arguments.length
        ? ((t0 = transform((x0 = +_[0]))), (t1 = transform((x1 = +_[1]))), (t2 = transform((x2 = +_[2]))), (k10 = t0 === t1 ? 0 : 0.5 / (t1 - t0)), (k21 = t1 === t2 ? 0 : 0.5 / (t2 - t1)), scale)
        : [x0, x1, x2];
    };
