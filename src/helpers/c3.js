...
(function (global, factory) {
  ...
  (function () {
    if (!('SVGPathSeg' in window)) {
      ...
      window.SVGPathSegArcAbs.prototype._asPathString = function () {
        return (
          this.pathSegTypeAsLetter + ' ' + this._r1 + ' ' + this._r2 + ' ' + this._angle + ' ' + (this._largeArcFlag ? '1' : '0') + ' ' + (this._sweepFlag ? '1' : '0') + ' ' + this._x + ' ' + this._y
        );
      };
  ...
  ChartInternal.prototype.getYDomain = function (targets, axisId, xDomain) {
    ...
    if (showHorizontalDataLabel) {
      ...
      var pixelsToAxisPadding = $$.getY(
        config['axis_'.concat(axisId, '_type')], // input domain as pixels
  ...
  ChartInternal.prototype.drawColorScale = function () {
    ...
    $$.colorScale
      .append('g')
      .attr('transform', 'translate(0, '.concat(config.stanford_padding.top, ')'))
      .selectAll('bars')
      .data(points)
      .enter()
      .append('rect')
    ...
    axisScale = d3
      ...
      .range([points[0] + config.stanford_padding.top + points[points.length - 1] + barHeight - 1, points[0] + config.stanford_padding.top]);
